...
class ManagerSleepActivity : AppCompatActivity() {
    private lateinit var binding: ActivityManagerSleepBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityManagerSleepBinding.inflate(layoutInflater)
        setContentView(binding.root)

        if(savedInstanceState == null){
            var fragment = SleepFragment()
